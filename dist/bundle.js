  ...
  \**************************************/
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        /* harmony export */ renderGame: () =>
                            /* binding */ renderGame,
                        /* harmony export */
                    },
                );
                /* harmony import */ var _cardDeck__WEBPACK_IMPORTED_MODULE_0__ =
                    __webpack_require__(
                        /*! ./cardDeck */ "./src/components/cardDeck.ts",
                    );
                /* harmony import */ var _renderStartHtml__WEBPACK_IMPORTED_MODULE_1__ =
                    __webpack_require__(
                        /*! ./renderStartHtml */ "./src/components/renderStartHtml.ts",
                    );
                ...
                function renderGame(size) {
                    ...
                    var cardsDeck =
                        _cardDeck__WEBPACK_IMPORTED_MODULE_0__.cardDeck
                            .sort(function () {
                                return Math.random() - 0.5;
                            })
                            .slice(0, size / 2);
                    //создание дубликата массива
                    var dublicateCardArray = cardsDeck
                        .concat(cardsDeck)
                        .sort(function () {
                            return Math.random() - 0.5;
                        });
                    ...
                    _renderStartHtml__WEBPACK_IMPORTED_MODULE_1__.appEl.innerHTML =
                        '<div class = "main-field ">\n    '
                            .concat(headerGame, ' <div class = "game-field">')
                            .concat(
                                dublicateCardArray.join(""),
                                "\n    </div>\n    ",
                            );
                    ...
                    reset.addEventListener("click", function () {
                        (0,
                        _renderStartHtml__WEBPACK_IMPORTED_MODULE_1__.renderStartHtml)();
                    });
                    //переменные
                    ...
                    function showAll() {
                        if (cards) {
                            var itemArray = Array.from(cards);
                            for (
                                var _i = 0, itemArray_1 = itemArray;
                                _i < itemArray_1.length;
                                _i++
                            ) {
                                var card = itemArray_1[_i];
                    ...
                    function hideAll() {
                        if (cards) {
                            var itemArray = Array.from(cards);
                            for (
                                var _i = 0, itemArray_2 = itemArray;
                                _i < itemArray_2.length;
                                _i++
                            ) {
                                var card = itemArray_2[_i];
     ...
     //            second = second < 10 ? "0" + second : second;
                    ...
                    function startTimer() {
                        interval = setInterval(function () {
                            ...
                            var minutes = Math.floor(elapsedTime / 60000)
                                ...
                                .padStart(2, "0");
                            var seconds = (
                                Math.floor((elapsedTime % 60000) / 1000) - 5
                            )
                                .toString()
                                .padStart(2, "0");
                            timer.innerHTML = ""
        ...
        /***/ "./src/components/renderStartHtml.ts":
            /*!*******************************************!*\
  !*** ./src/components/renderStartHtml.ts ***!
  \*******************************************/
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        ...
                        /* harmony export */ renderStartHtml: () =>
                            /* binding */ renderStartHtml,
                        /* harmony export */
                    },
                );
                /* harmony import */ var _renderGame__WEBPACK_IMPORTED_MODULE_0__ =
                    __webpack_require__(
                        /*! ./renderGame */ "./src/components/renderGame.ts",
                    );
  ...
  */
                    ...
                    if (formEl) {
                        formEl.addEventListener("submit", function (event) {
                            event.preventDefault();
                            var easyLevel =
                                document.querySelector(".easy-level");
                            var mediumLevel =
                                document.querySelector(".medium-level");
                            var hardLevel =
                                document.querySelector(".hard-level");
                            if (easyLevel.checked) {
                                (0,
                                _renderGame__WEBPACK_IMPORTED_MODULE_0__.renderGame)(
                                    6,
                                );
                            }
  ...
  \**********************/
        ...
        /* harmony import */ var _components_renderStartHtml__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
                /*! ./components/renderStartHtml */ "./src/components/renderStartHtml.ts",
            );
        /* eslint-disable no-unused-vars */

        (0,
        _components_renderStartHtml__WEBPACK_IMPORTED_MODULE_1__.renderStartHtml)();
    })();
