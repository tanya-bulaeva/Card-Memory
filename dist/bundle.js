...
function renderGame(size) {
    ...
    var cardsDeck = _cardDeck__WEBPACK_IMPORTED_MODULE_0__.cardDeck.sort(function () { return Math.random() - 0.5; }).slice(0, size / 2);
    ...
    _renderStartHtml__WEBPACK_IMPORTED_MODULE_1__.appEl.innerHTML = "<div class = \"main-field \">\n    ".concat(headerGame, " <div class = \"game-field\">").concat(dublicateCardArray.join(""), "\n    </div>\n    ");
    //обработчик событий на кнопку сброса
    var reset = document.getElementById("reset");
    reset.addEventListener("click", function () {
        (0,_renderStartHtml__WEBPACK_IMPORTED_MODULE_1__.renderStartHtml)();
    });
    //переменные
    ...
    function startTimer() {
        interval = setInterval(function () {
            ...
            timer.innerHTML = "".concat(minutes, ".").concat(seconds);
        }, 1000);
        state = 0;
    }
    //
    ...
    function checkForMatch() {
        var isMatch = firstCard.dataset.index === secondCard.dataset.index;
        if (!isMatch) {
            setTimeout(function () {
...
/* harmony export */ });
/* harmony import */ var _renderGame__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./renderGame */ "./src/components/renderGame.ts");
...
/* harmony import */ var _components_renderStartHtml__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/renderStartHtml */ "./src/components/renderStartHtml.ts");
/* eslint-disable no-unused-vars */
